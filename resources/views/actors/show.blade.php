...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img class="" src="{{ $actor->profilePath }}" alt="Abdullah" class="w-54 md:w-96" style="width: 24rem">
                <ul class="flex items-center mt-4">

                    @if ($actor->social->facebook)
                        <li>
                            <a href="{{ $actor->social->facebook }}" title="Facebook" target="_blank">
                    ...
                    @if ($actor->social->instagram)
                        <li class="ml-6">
                            <a href="{{ $actor->social->instagram }}" title="Instagram" target="_blank">
                                <svg class="fill-current text-gray-400 hover:text-white w-6" viewBox="0 0 448 512">
                                    <path
                    ...
                    @if ($actor->social->twitter)
                        <li class="ml-6">
                            <a href="{{ $actor->social->twitter }}" title="Twitter" target="_blank">
