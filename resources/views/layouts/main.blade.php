...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="container px-4 mx-auto flex flex-col md:flex-row items-center justify-between py-6">
            <ul class="flex flex-col md:flex-row items-center">
                <li>
                    <a href="{{ route('movies.index') }}" class="text-sm font-bold hover:text-gray-800"><svg
                            class="w-32" viewBox="0 0 96 24" fill="none">
                            <path
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movies.index') }}" class="text-gray-300">Movies</a>
                </li>

                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="#" class="text-gray-300">TV Shows</a>
                </li>
            ...
            <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="{{ asset('assets/img/DSC_4827.JPG') }}" alt="avatar" class="rounded-full w-8 h-8" />
                    </a>
                </div>
            </div>
        </div>
