    ...
    <nav class="border-b border-gray-800">
        <div class="container px-4 mx-auto flex flex-col md:flex-row items-center justify-between py-6">
            <ul class="flex flex-col md:flex-row items-center">
                <li>
                    <a href="{{ route('movie.index') }}" class="text-sm font-bold hover:text-gray-800"><svg
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movie.index') }}" class="text-gray-300">Movies</a>
                </li>

                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="{{ route('tv.index') }}" class="text-gray-300">TV Shows</a>
                </li>
            ...
            <div class="flex flex-col md:flex-row items-center">
                <livewire:search-dropdown>
                    <div class="md:ml-4 mt-3 md:mt-0">
                        <a href="#">
                            <img src="{{ asset('assets/img/DSC_4827.JPG') }}" alt="avatar"
